...
type Props = NativeStackScreenProps<RootStackParamList, 'BuatKelas'>;

export default function BuatKelas({ navigation }: Props) {
      ...
      <View style={{ padding: 20 }}>
        ...
        <View style={{ marginTop: 20 }}>
          ...
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('DetailKelas', { namaKelas })}
          >
